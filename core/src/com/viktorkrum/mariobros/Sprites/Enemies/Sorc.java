...
public class Sorc extends Enemy
{
    ...
    public void update(float dt){
        ...
        if(b2body.getPosition().x < inactiveBody - 3 && b2body.getPosition().x > inactiveBody -4) {
            travelDirection = -5;
            travelDirectiony = 2;
            b2body.setLinearVelocity(new Vector2(travelDirection, travelDirectiony));
        ...
        if((b2body.getPosition().x < inactiveBody - 6 && b2body.getPosition().x > inactiveBody -7) && (b2body.getPosition().y < inactiveBodyy -1 && b2body.getPosition().y > inactiveBodyy -2)) {
            travelDirection = 6;
            travelDirectiony = 2;
        ...
        if(b2body.getPosition().y > inactiveBodyy +3 && b2body.getPosition().y < inactiveBodyy +4) {
            travelDirection = 6;
            travelDirectiony = -2;
