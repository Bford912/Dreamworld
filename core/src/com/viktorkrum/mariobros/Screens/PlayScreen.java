...
import com.viktorkrum.mariobros.Sprites.Enemies.Enemy;
...
public class PlayScreen extends ApplicationAdapter implements Screen{
   ...
   // private boolean canDoubleJump;
    ...
    public PlayScreen(MarioBros game) {
        blank = new Texture("healthbars1.png");
        blank1 = new Texture("healthbars2.jpg");
    ...
    public void show() {
        ...
        int whatever = player.getMarioHealth();
        System.out.println("this is " + whatever);
    ...
    public void HealthBars(float dt){
        if (healths > 0){
    ...
    * */
    /*public boolean handleInput2 (float dt) {
        ...
        if (controller.isUpPressed() && player.b2body.getLinearVelocity().y == 0) {
            ...
            if (System.currentTimeMillis() - lastTap < 640)
                return true;
 ...
 +            * */
    ...
    public void update(float dt){
        ...
        for(com.viktorkrum.mariobros.Sprites.Enemies.Enemy enemy : creator.getEnemies()) {
            enemy.update(dt);
            if(enemy.getX() < player.getX() + 1200/ MarioBros.PPM) {
    ...
    public void render(float delta) {
       ...
       // b2dr.render(world, gamecam.combined);
        ...
        game.batch.draw(blank, player.getX(), player.getY()+1.45f, 1, 1.2f);
        game.batch.draw(blank1, player.getX()+.434f, player.getY()+1.91f, player.getMarioHealth()*.17f, .22f);
