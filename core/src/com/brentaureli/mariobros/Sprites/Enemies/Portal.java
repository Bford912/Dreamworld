 ...
 */
public class Portal extends com.brentaureli.mariobros.Sprites.Enemies.Enemy
{
    ...
    public Portal(PlayScreen screen, float x, float y) {
        ...
        for(int i = 0; i < 3; i++)
            frames.add(new TextureRegion(screen.getAtlas().findRegion("portal2"), i * 68, 0, 68, 68));
        walkAnimation = new Animation(0.1f, frames);
        stateTime = 0;
        setBounds(getX(), getY(), 100/ MarioBros.PPM, 100 / MarioBros.PPM);
        setToDestroy = false;
        destroyed = false;
        angle = 0;
    ...
    public void update(float dt){
        ...
        if(setToDestroy && !destroyed){
            ...
            destroyed = true;
            setRegion(new TextureRegion(screen.getAtlas().findRegion("portal2"), 68, 0, 68, 68));
            stateTime = 0;
        }
